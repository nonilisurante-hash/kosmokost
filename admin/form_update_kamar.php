    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h3>Aplikasi KosmoKost - Update Data Kamar</h3>
                            ...
                            <div class="card-body">
                                <form action="update_kamar.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="gambar" name="gambar" placeholder="Gambar Kamar" class="form-control mt-3" accept="image/*">
                                        <input type="text" class="form-control" id="gambar_lama" name="gambar_lama" value="<?= $hasil[0]['gambar'] ?>" hidden>
                                    </div>
                                    <div class="form-group">
                                        <label>Harga Kamar</label>
                                        <input type="number" name="harga" placeholder="Harga Kamar" class="form-control" value="<?= $hasil[0]['harga'] ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Deskripsi Kamar</label>
                                        <textarea name="deskripsi" cols="30" rows="5" class="form-control" required><?= $hasil[0]['deskripsi'] ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Status Kamar</label>
                                        <select name="status" class="form-control" required>
                                            <option value="<?= $hasil[0]['status']; ?>" selected><?= $hasil[0]['status']; ?></option>
                                                <?php if($hasil[0]['status']=='Berpenghuni') :?>
