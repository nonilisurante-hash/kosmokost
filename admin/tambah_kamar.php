    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h3>Aplikasi KosmoKost - Tambah Kamar</h3>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="daftar_kamar.php" class="btn btn-secondary btn-icon-split">
                                    <span class="text">Daftar Kamar</span>
                                </a>
                            </div>
                            ...
                            <div class="card-body">
                                <form action="simpan_kamar.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="no_kamar" placeholder="No. Kamar" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Harga Kamar</label>
                                        <input type="number" name="harga" placeholder="Harga Kamar" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="gambar" placeholder="Gambar Kamar" class="form-control" required>
                                    </div>
                                    <div class="form-group">
