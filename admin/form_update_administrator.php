    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h3>Aplikasi KosmoKost - Update Administrator</h3>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="update_administrator.php" method="POST">
                                        <input type="hidden" name="id_user" value="<?= $hasil[0]['id_user']; ?>">
                                    <div class="form-group">
                                        <label>Username</label>
                                        <input type="text" name="username" placeholder="Username" class="form-control" value="<?= $hasil[0]['username']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input type="text" name="password" placeholder="Password" class="form-control" value="<?= $hasil[0]['password'] ?>" required>
                                    </div>
                                    <div class="form-group">
