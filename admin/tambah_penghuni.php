    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h3>Aplikasi KosmoKost - Tambah Penghuni</h3>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="daftar_penghuni.php" class="btn btn-secondary btn-icon-split">
                                    <span class="text">Daftar Penghuni</span>
                                </a>
                            </div>

                            <div class="card-body">
                            <form action="simpan_penghuni.php" method="POST">
                                    <!-- Form Data Penghuni -->
                                    <div class="form-group">
                                        <label>No. Kamar</label>
                                        <select name="no_kamar" class="form-control" required>
                                            <?php foreach($hasil as $kamar): ?>
                                    ...
                                    <div class="form-group">
                                        <label>No. KTP</label>
                                        <input type="number" name="no_ktp" placeholder="No. KTP" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Nama</label>
                                    ...
                                    <div class="form-group">
                                        <label>Status</label>
                                        <!-- <input type="text" name="status" placeholder="Password" class="form-control" value="penghuni" readonly required> -->
